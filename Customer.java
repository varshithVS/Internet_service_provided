...
ResultSet rs;
    ...
    public void jTable1(){
        ...
        public void Update(){
        try{
            pst = conn.prepareStatement("UPDATE `customer` SET Plan=?, name='"+jTextField2.getText()+"', contact='"+jTextField3.getText()+"',sex='"+(String)jComboBox1.getSelectedItem()+"',purpose='"+(String)jComboBox2.getSelectedItem()+"', address='"+jTextField4.getText()+"' WHERE id=?");
